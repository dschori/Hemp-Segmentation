...
class FeatureSelector():
    ...
    def identify_zero_importance(self, task, eval_metric=None, 
        ...
        for _ in range(n_iterations):
            ...
            if task == 'classification':
                model = lgb.LGBMClassifier(n_estimators=1000, learning_rate = 0.01, verbose = -1)

            elif task == 'regression':
                model = lgb.LGBMRegressor(n_estimators=1000, learning_rate = 0.01, verbose = -1)
            ...
            if early_stopping:
                ...
                train_features, valid_features, train_labels, valid_labels = train_test_split(features, labels, test_size = 0.3, stratify=labels)
    ...
    def plot_feature_importances(self, plot_n = 15, cumulative=False, threshold = None):
        """
